...
<body>
	...
	<p>The following definitions shall have the same meaning regardless
		of whether they appear in singular or in plural.</p>

	<h2>Definitions</h2>
	<p>For the purposes of these Terms and Conditions:</p>
	<ul>
		<li><strong>Affiliate</strong> means an entity that controls, is
		...
		<li><strong>Company</strong> (referred to as either "the
			Company", "We", "Us" or "Our" in this Agreement) refers to NoleJava.</li>
		...
		<li><strong>Terms and Conditions</strong> (also referred as
			"Terms") mean these Terms and Conditions that form the entire
			agreement between You and the Company regarding the use of the
			Service. This Terms and Conditions agreement is maintained by the <a
			href="https://www.freeprivacypolicy.com/free-terms-conditions-generator/">Free
				Terms and Conditions Generator</a>.</li>
		<li><strong>Third-party Social Media Service</strong> means any
			...
			or made available by the Service.</li>
		<li><strong>Website</strong> refers to NoleJava, accessible from
			www.nolejava.com</li>
		<li><strong>You</strong> means the individual accessing or using
	...
	<p>These are the Terms and Conditions governing the use of this
	...
	<p>You represent that you are over the age of 18. The Company does
		not permit those under 18 to use the Service.</p>
	<p>Your access to and use of the Service is also conditioned on
	...
	<p>Our Service may contain links to third-party web sites or
		services that are not owned or controlled by the Company.</p>
	<p>The Company has no control over, and assumes no responsibility
	...
	<h1>Termination</h1>
	<p>We may terminate or suspend Your access immediately, without
	...
	<p>Notwithstanding any damages that You might incur, the entire
		...
		100 USD if You haven't purchased anything through the Service.</p>
	...
	<p>Without limiting the foregoing, neither the Company nor any of
	...
	<p>Some jurisdictions do not allow the exclusion of certain types
	...
	<h1>Governing Law</h1>
	<p>The laws of the Country, excluding its conflicts of law rules,
		shall govern this Terms and Your use of the Service. Your use of the
		Application may also be subject to other local, state, national, or
		international laws.</p>

	<h1>Disputes Resolution</h1>
	<p>If You have any concern or dispute about the Service, You agree
	...
	<p>These Terms and Conditions may have been translated if We have
		made them available to You on our Service.</p>
	<p>You agree that the original English text shall prevail in the
		case of a dispute.</p>
	...
	<p>If you have any questions about these Terms and Conditions, You
		can contact us: amministratore.nolejava@gmail.com</p>
